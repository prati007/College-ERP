...
class InfoTest(TestCase):
    ...
    def test_user_creation(self):
        ...
        s = Student(user=us, USN='18BTRCS001', name='test')
        s.save()
        t = Teacher(user=ut, id='T1', name='test')
        t.save()
    ...
    def create_course(self, id='18CIC53', name='Database System', shortname='DBMS'):
    ...
    def create_student(self, usn='18BTRCS001', name='aakash'):
    ...
    def create_teacher(self, id='T1', name='teacher'):
